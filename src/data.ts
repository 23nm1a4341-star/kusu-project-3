...
const GEN_DATA: Record<string, {
  ...
  "Traditional Wear": {
    ...
    brands: ["KUSU Heritage", "KUSU Royal", "Jaipur weaves", "Southern Silk", "Benares Craft", "Lucknowi Thread"],
  ...
  "Western Wear": {
    ...
    brands: ["KUSU Cyber", "Denim Lab", "Boho Vibe", "Urbanite", "Aura Apparel", "Pacific Club"],
  ...
  "Formal Wear": {
    ...
    brands: ["Savile Club", "KUSU Corporate", "KUSU Class", "Milano Sartorial", "Regal Dress"],
  ...
  "Sports Wear": {
    ...
    brands: ["KUSU Run", "Aerofit", "Stealth Gym", "Velocity Pro", "Vanguard Sport"],
  ...
  "Kids Wear": {
    ...
    brands: ["KUSU Uniforms", "Smart Kids", "Playground Essentials", "Tiny Threads", "Cloud Kids"],
  ...
  "College Uniforms": {
    ...
    brands: ["KUSU Academy", "KUSU Collegiate", "Oxford Tweed", "MIT official", "KUSU Uniforms"],
